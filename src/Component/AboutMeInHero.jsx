    ...
    return (
        <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-cyan-600 text-white py-16 px-6">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-6 space-y-4 text-xl leading-relaxed">
                        ...
                        <p>
                            ...
                            <span className="text-indigo-400 font-semibold">Java, Javascript and MERN Stack.</span>
                        </p>
                        <p>
                            My field of Interest's are building new{" "}
                            <span className="text-indigo-400 italic">Web Technologies and Products</span> and also interested in{" "}
                ...
                <div className="flex-1 flex justify-center">
                    <div className="relative w-80 h-80 perspective">
                        <div className="absolute w-full h-full transition-transform duration-700 transform-style-preserve-3d hover:rotate-y-180">
                            ...
                            <div className="absolute w-full h-full rotate-y-180 backface-hidden flex items-center justify-center rounded-full overflow-hidden shadow-lg">
                                <img
                                    src={myImage} // replace with your real image
                                    alt="Profile"
                                    className="w-full h-full object-cover"
                                />
                            </div>
            ...
            <div className="mt-16 text-center">
                ...
                <p className="text-gray-400">Feel free to <span className="text-indigo-400">connect</span> with me</p>
                <div className="flex justify-center gap-6 mt-4 text-2xl text-indigo-400 ">
                    <a className="bg-white w-10  rounded-full overflow-hidden flex items-center justify-center p-2" href="https://github.com/Satishsatyarth" target="_blank" rel="noreferrer"><FaGithub /></a>
                    <a className="bg-white w-10  rounded-full overflow-hidden flex items-center justify-center p-2" href="https://www.linkedin.com/in/satish-kumar-619164271/" target="_blank" rel="noreferrer"><FaLinkedin /></a>
                    <a className="bg-white w-10  rounded-full overflow-hidden flex items-center justify-center p-2" href="https://instagram.com" target="_blank" rel="noreferrer"><FaInstagram /></a>
                </div>
            </div>
        </section>
    );
